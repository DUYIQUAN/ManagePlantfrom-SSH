	...
	public String GR_loadInfor(HttpServletRequest request) throws IOException {
		...
		//try {
			...
			PHCSMP_Personal_Check personal_Check = personalCheckService
			  ...
			  int personal_Check_complete_degree = (int) (personal_Check.getFill_record()
					/ (float) personal_Check.getTotal_record() * 100);
			System.out.println("personal_Check_complete_degree"+personal_Check_complete_degree+"------------------------------------");
			request.setAttribute("personal_Check_complete_degree", personal_Check_complete_degree);
			...
			PHCSMP_Information_Collection information_Collection = informationCollectionService
			  ...
			  int information_Collection_complete_degree = (int) (information_Collection.getFill_record()
					/ (float) information_Collection.getTotal_record() * 100);
			System.out.println("information_Collection_complete_degree"+information_Collection_complete_degree+"------------------------------------");
			request.setAttribute("information_Collection_complete_degree", information_Collection_complete_degree);
